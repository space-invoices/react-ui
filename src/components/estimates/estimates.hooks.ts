import type { CreateEstimate, CustomCreateEstimate, Estimate, UpdateEstimate } from "@spaceinvoices/js-sdk";
...
} = createResourceHooks<Estimate, CreateEstimate, UpdateEstimate>(
  {
