export default {
  ...
  "Tax ID 2": "Numer podatkowy 2",
  "Secondary tax identification number (optional)": "Dodatkowy numer identyfikacji podatkowej (opcjonalnie)",
  ...
  "Billing email address": "Adres e-mail do rozliczeń",
  "Recipient for white-label subscription billing emails.":
    "Odbiorca wiadomości rozliczeniowych subskrypcji white-label.",
  "Used as the From address for document emails and payment reminders after verification passes.":
    "Używany jako adres From dla wiadomości z dokumentami i przypomnień o płatności po udanej weryfikacji.",
  "DNS DKIM tokens": "Tokeny DNS DKIM",
  "Add CNAME records for these tokens at your sender domain, then recheck.":
    "Dodaj rekordy CNAME dla tych tokenów w domenie nadawcy, a następnie sprawdź ponownie.",
  "DNS records are being prepared. Recheck in a moment if they do not appear.":
    "Rekordy DNS są przygotowywane. Sprawdź ponownie za chwilę, jeśli się nie pojawią.",
  "CNAME record": "Rekord CNAME",
  Name: "Nazwa",
  Value: "Wartość",
  Copy: "Kopiuj",
  Copied: "Skopiowano",
  Saving: "Zapisywanie",
  "Save sender": "Zapisz nadawcę",
  "Update sender": "Zaktualizuj nadawcę",
  Clear: "Wyczyść",
  ...
  Email: "E-mail",
  Domain: "Domena",
  "Inherited from white-label": "Odziedziczone z white-label",
  "Entity Email": "E-mail podmiotu",
  "Invalid email address": "Nieprawidłowy adres e-mail",
  "Email shown for this entity on documents and template variables":
    "E-mail wyświetlany dla tego podmiotu w dokumentach i zmiennych szablonu",
  ...
  "Subject line for invoice emails": "Temat dla emaili z fakturami",
  "Subject line for estimate emails": "Temat dla emaili z wycenami",
  "Subject line for credit note emails": "Temat dla emaili z notami kredytowymi",
  "Subject line for advance invoice emails": "Temat dla emaili z fakturami zaliczkowymi",
  "Subject line for delivery note emails": "Temat dla emaili z listami przewozowymi",
  "Body content for invoice emails": "Tresc tekstu dla emaili z fakturami",
  "Body content for estimate emails": "Tresc tekstu dla emaili z wycenami",
  "Body content for credit note emails": "Tresc tekstu dla emaili z notami kredytowymi",
  "Body content for advance invoice emails": "Tresc tekstu dla emaili z fakturami zaliczkowymi",
  "Body content for delivery note emails": "Tresc tekstu dla emaili z listami przewozowymi",
  Reminder: "Przypomnienie",
  "Payment reminders": "Przypomnienia o płatności",
  "Reminder subject": "Temat przypomnienia",
  "Subject line for payment reminder emails": "Temat wiadomości z przypomnieniem o płatności",
  "Reminder body": "Treść przypomnienia",
  "Body content for payment reminder emails": "Treść wiadomości z przypomnieniem o płatności",
  "Payment instructions": "Instrukcje płatności",
  "Payment instructions appended to reminder emails when not included in the body":
    "Instrukcje płatności dodawane do przypomnień, gdy nie są zawarte w treści",
  "Payment reminder from {entity_name}": "Przypomnienie o płatności od {entity_name}",
  "Hello {customer_name},\n\nThe following invoices are overdue:\n{invoice_list}\n\n{payment_instructions}":
    "Dzień dobry {customer_name},\n\nNastępujące faktury są przeterminowane:\n{invoice_list}\n\n{payment_instructions}",
  "Please remit payment to IBAN {iban}.": "Prosimy o dokonanie płatności na IBAN {iban}.",
  ...
  Preview: "Podgląd",
  // Tax rules settings
  "Main documents": "Dokumenty główne",
  "Used when no business unit is selected.": "Używane, gdy nie wybrano jednostki biznesowej.",
  "Business-unit documents": "Dokumenty jednostki biznesowej",
  "Used when a business unit is selected. Default formats should include {u} to stay distinct.":
    "Używane, gdy wybrano jednostkę biznesową. Domyślne formaty powinny zawierać {u}, aby pozostały odrębne.",
  "If this format matches the main document format, saving is blocked.":
    "Jeśli ten format jest taki sam jak format główny, zapis zostanie zablokowany.",
  "Business-unit numbering must differ from the main document format.":
    "Numeracja jednostki biznesowej musi różnić się od formatu głównego.",
  "First number to use": "Pierwszy numer do użycia",
  "First number to use for this unit": "Pierwszy numer do użycia dla tej jednostki",
  "first number to use": "pierwszy numer do użycia",
  "Only affects this business unit for this document type. Existing documents are not renumbered.":
    "Dotyczy tylko tej jednostki biznesowej dla tego typu dokumentu. Istniejące dokumenty nie zostaną ponownie ponumerowane.",
  "Set the first number for this unit by document type. The unit number format is shared in Numbering settings.":
    "Ustaw pierwszy numer dla tej jednostki według typu dokumentu. Format numeru jednostki jest wspólny w ustawieniach numeracji.",
  "Edit shared unit format": "Edytuj wspólny format jednostek",
  "first number": "pierwszy numer",
  "Unit numbering": "Numeracja jednostki",
  Numbering: "Numeracja",
  "Only affects this business unit for the selected document type. Existing documents are not renumbered.":
    "Dotyczy tylko tej jednostki biznesowej dla wybranego typu dokumentu. Istniejące dokumenty nie zostaną ponownie ponumerowane.",
  "Can only move future numbering forward. Existing documents are not renumbered.":
    "Może tylko przesunąć przyszłą numerację do przodu. Istniejące dokumenty nie są przenumerowywane.",
  "Insert token": "Wstaw token",
  "Number tokens": "Tokeny numeracji",
  "Full year": "Pełny rok",
  "Short year": "Krótki rok",
  "Sequence number": "Numer kolejny",
  "Business unit index": "Indeks jednostki biznesowej",
  ...
  "Manual taxes": "Ręczne podatki",
  "Create tax rates on the Taxes page and apply them to document lines.":
    "Utwórz stawki podatkowe na stronie Podatki i stosuj je do pozycji dokumentu.",
  ...
  "tax-rules.calculation_mode.label": "Tryb obliczania",
  "tax-rules.calculation_mode.description":
    "Wybierz kolejność stosowania rabatów i VAT podczas obliczania sum dokumentu.",
  "tax-rules.calculation_mode.b2b_standard.label": "Standard B2B",
  "tax-rules.calculation_mode.b2b_standard.description":
    "Rabaty najpierw obniżają kwotę netto pozycji, a następnie naliczany jest VAT.",
  "tax-rules.calculation_mode.b2c_gross_discount.label": "Rabat brutto B2C",
  "tax-rules.calculation_mode.b2c_gross_discount.description":
    "Rabaty obniżają końcową kwotę brutto do zapłaty, a następnie na tej podstawie wyliczane są netto i VAT.",
  ...
  "Default due days": "Domyślne dni terminu płatności",
  "Default valid days": "Domyślne dni ważności",
  "Number of days added to the document date for new invoice due dates":
    "Liczba dni dodawana do daty dokumentu dla nowych terminów płatności faktur.",
  "Number of days added to the document date for new estimate valid-till dates":
    "Liczba dni dodawana do daty dokumentu dla nowych terminów ważności wycen.",

  // Portugal entity details
  "Portugal Details": "Dane dla Portugalii",
  "Portuguese invoices carry these details. What is required depends on your legal form.":
    "Portugalskie faktury zawierają te dane. To, które z nich są wymagane, zależy od formy prawnej.",
  "Legal Form": "Forma prawna",
  "Select your legal form": "Wybierz formę prawną",
  "Decides which registration and capital details Portugal asks you for":
    "Decyduje, jakich danych rejestrowych i kapitałowych wymaga Portugalia",
  "Individual professional or sole trader": "Osoba wykonująca wolny zawód lub jednoosobowa działalność gospodarcza",
  "Private limited company (Lda.)": "Spółka z ograniczoną odpowiedzialnością (Lda.)",
  "Public limited company (S.A.)": "Spółka akcyjna (S.A.)",
  "Partnership limited by shares": "Spółka komandytowo-akcyjna",
  "Other company": "Inna spółka",
  "Company Number": "Numer rejestrowy",
  "Digits and slashes only, as shown on your registration.": "Tylko cyfry i ukośniki, tak jak we wpisie rejestrowym.",
  "Registry Office": "Urząd rejestrowy",
  "Commercial registry where the company is registered": "Rejestr handlowy, w którym spółka jest zarejestrowana",
  Phone: "Telefon",
  "Enter 912 345 678 for Portugal, or include + and the country code for another country.":
    "Wpisz 912 345 678 dla Portugalii albo podaj + i numer kierunkowy kraju dla innego kraju.",
  "Enter 7 digits; the hyphen is added automatically.": "Wpisz 7 cyfr; myślnik zostanie dodany automatycznie.",
  "9 digits. You can paste it with spaces or a PT prefix.":
    "9 cyfr. Możesz go wkleić ze spacjami lub z przedrostkiem PT.",
  "Share Capital": "Kapitał zakładowy",
  "Registered share capital of the company": "Zarejestrowany kapitał zakładowy firmy",
  "Conditional company disclosures": "Warunkowe informacje o spółce",
  "Leave these empty unless one of them applies to your company.":
    "Pozostaw te pola puste, chyba że któreś z nich dotyczy Twojej spółki.",
  "Paid-up Capital": "Kapitał wpłacony",
  "Only needed when less than the share capital has actually been paid in":
    "Wymagane tylko wtedy, gdy faktycznie wpłacono mniej niż kapitał zakładowy",
  ...
  "Only needed when equity has fallen to half the share capital or less. Use the figure from your last approved balance sheet.":
    "Wymagane tylko wtedy, gdy kapitał własny spadł do połowy kapitału zakładowego lub poniżej. Podaj wartość z ostatniego zatwierdzonego bilansu.",
  "Company is in liquidation": "Spółka w likwidacji",
  "Documents must say so while the company is being wound up":
    "Dokumenty muszą to wskazywać przez cały czas trwania likwidacji spółki",
  ...
  "Choose how prices, discounts, and taxes are calculated on documents.":
    "Wybierz sposób obliczania cen, rabatów i podatków na dokumentach.",
  "EU cross border rules": "Zasady UE dotyczące transakcji transgranicznych",
  "Validate VAT numbers and automate reverse charge for eligible EU transactions.":
    "Weryfikuj numery VAT i automatyzuj odwrotne obciążenie dla kwalifikujących się transakcji w UE.",
  "Export rules": "Zasady eksportu",
  "Configure automatic tax handling for transactions outside the EU.":
    "Skonfiguruj automatyczne rozliczanie podatku dla transakcji poza UE.",
  "Configure domestic Slovenian tax treatments.": "Skonfiguruj krajowe słoweńskie zasady podatkowe.",
  "Slovenian Article 76.a": "Słoweński artykuł 76.a",
  "Allow eligible domestic business invoices to report VAT under reverse charge.":
    "Zezwalaj, aby kwalifikujące się krajowe faktury B2B wykazywały VAT w ramach odwrotnego obciążenia.",
  "Article 76.a tax clause": "Klauzula podatkowa artykułu 76.a",
  "Default legal clause added when Article 76.a is selected on an invoice.":
    "Domyślna klauzula prawna dodawana po wybraniu artykułu 76.a na fakturze.",
