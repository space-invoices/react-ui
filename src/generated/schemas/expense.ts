...
// Schema for createExpense operation
const createExpenseSchemaDefinition = z
  .object({
    ...
    items: z.union([z.array(CreateExpenseItem), z.null()]),
...
// Schema for updateExpense operation
const updateExpenseSchemaDefinition = z
  .object({
    is_draft: z.boolean(),
    supplier_id: z.union([z.string(), z.null()]),
    supplier: z.union([ExpenseSupplier, z.null()]),
...
export type CreateExpenseSchema = z.infer<typeof createExpenseSchemaDefinition>;
export const createExpenseSchema = createExpenseSchemaDefinition;
export type UpdateExpenseSchema = z.infer<typeof updateExpenseSchemaDefinition>;
export const updateExpenseSchema = updateExpenseSchemaDefinition;
