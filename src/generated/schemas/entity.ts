...
// Dependency schema for entity
const SloveniaTaxRules = z
  .object({
    article_76a_enabled: z.union([z.boolean(), z.null()]).default(false),
  })
  .partial()
  .passthrough();
...
const TaxRules = z
  .object({
    eu: z.union([EuTaxRules, z.null()]),
    slovenia: z.union([SloveniaTaxRules, z.null()]),
  })
  .partial()
  .passthrough();
...
const createEntitySchemaDefinition = z.object({
  ...
  address_2: z.union([z.string().max(500), z.null()]).optional(),
  post_code: z.union([z.string().max(20), z.null()]).optional(),
  city: z.union([z.string().max(100), z.null()]).optional(),
  state: z.union([z.string().max(100), z.null()]).optional(),
  country: z.string().min(1).max(100),
  country_code: z.union([z.string().min(2).max(2), z.null()]).optional(),
  currency_code: z.union([z.string().max(3), z.null()]).optional(),
  locale: z.union([z.string().max(20), z.null()]).optional(),
  timezone: z.string().max(100).optional(),
  tax_number: z.union([z.string().max(50), z.null()]).optional(),
  tax_number_2: z.union([z.string().max(50), z.null()]).optional(),
  company_number: z.union([z.string().max(50), z.null()]).optional(),
  phone: z.union([z.string().max(50), z.null()]).optional(),
  email: z.union([z.string().max(255), z.null()]).optional(),
  website: z.union([z.string().max(500), z.null()]).optional(),
  fiscal_region_code: z.union([z.string().max(10), z.null()]).optional(),
