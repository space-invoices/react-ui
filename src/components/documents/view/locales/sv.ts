export default {
  ...
  "UJP package download failed": "Nedladdning av UJP-paket misslyckades",
  XRechnung: "XRechnung",
  ZUGFeRD: "ZUGFeRD",
  "XRechnung download failed": "Nedladdning av XRechnung misslyckades",
  "ZUGFeRD download failed": "Nedladdning av ZUGFeRD misslyckades",
  "e-SLOG validation must be valid before downloading.": "e-SLOG-valideringen måste vara giltig före nedladdning.",
  "UJP validation must be valid before downloading.": "UJP-valideringen måste vara giltig före nedladdning.",
  "German e-invoice validation must be valid before downloading.":
    "Valideringen av den tyska e-fakturan måste vara giltig före nedladdning.",
  "XRechnung validation must be valid before downloading.":
    "XRechnung-valideringen maste vara giltig innan nedladdning.",
  "ZUGFeRD validation must be valid before downloading.": "ZUGFeRD-valideringen maste vara giltig innan nedladdning.",
  ...
  "Not fiscalized": "Inte fiskaliserad",
  Fiscalize: "Fiskalisera",
