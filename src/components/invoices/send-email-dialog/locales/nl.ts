export default {
  ...
  "Recipient email is required": "E-mail van ontvanger is verplicht",
  "Invalid email address": "Ongeldig e-mailadres",
  "Add recipient": "Ontvanger toevoegen",
  "Remove recipient": "Ontvanger verwijderen",
  "You can add up to 4 recipients": "Je kunt maximaal 4 ontvangers toevoegen",
  Subject: "Onderwerp",
  ...
  "Sandbox email recipient restriction":
    "In sandbox-modus kunnen e-mails alleen worden verzonden naar geverifieerde teamleden van dit account.",
  "Sandbox email daily limit exceeded": "Dit sandbox-account kan slechts {limit} e-mails per dag verzenden.",
  "Email and attachment language": "Taal van e-mail en bijlage",
  "PDF Language": "PDF-taal",
  "Attach link to PDF": "Link naar PDF bijvoegen",
  "Attach PDF as file": "PDF als bestand bijvoegen",
  Default: "Standaard",
