export default {
  ...
  "Recipient email is required": "El correo del destinatario es obligatorio",
  ...
  "You can add up to 4 recipients": "Puedes añadir hasta 4 destinatarios",
  Subject: "Asunto",
  ...
  "Sandbox email recipient restriction":
    "En modo sandbox solo se pueden enviar correos a los miembros verificados del equipo de esta cuenta.",
  "Sandbox email daily limit exceeded": "Esta cuenta sandbox solo puede enviar {limit} correos al día.",
  "Email and attachment language": "Idioma del correo y del archivo adjunto",
  "PDF Language": "Idioma del PDF",
  "Attach link to PDF": "Adjuntar enlace al PDF",
  "Attach PDF as file": "Adjuntar PDF como archivo",
