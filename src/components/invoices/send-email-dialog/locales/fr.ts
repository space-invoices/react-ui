export default {
  ...
  "Recipient email is required": "L'e-mail du destinataire est requise",
  "Invalid email address": "Adresse e-mail invalide",
  "Add recipient": "Ajouter un destinataire",
  "Remove recipient": "Supprimer le destinataire",
  "You can add up to 4 recipients": "Vous pouvez ajouter jusqu'à 4 destinataires",
  Subject: "Objet",
  ...
  "Email verification required description": "Veuillez vérifier votre adresse e-mail avant d'envoyer des e-mails.",
  ...
  "Sandbox email recipient restriction":
    "En mode sandbox, les e-mails ne peuvent être envoyés qu'aux membres vérifiés de l'équipe de ce compte.",
  "Sandbox email daily limit exceeded": "Ce compte sandbox ne peut envoyer que {limit} e-mails par jour.",
  "Email and attachment language": "Langue de l'e-mail et de la pièce jointe",
  "PDF Language": "Langue du PDF",
  "Attach link to PDF": "Joindre le lien vers le PDF",
  "Attach PDF as file": "Joindre le PDF comme fichier",
  Default: "Par défaut",
