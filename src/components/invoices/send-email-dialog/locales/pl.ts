export default {
  ...
  "Send Credit Note by Email": "Wyślij notę kredytową e-mailem",
  ...
  "Remove recipient": "Usuń odbiorcę",
  "You can add up to 4 recipients": "Możesz dodać maksymalnie 4 odbiorców",
  Subject: "Temat",
  ...
  "Sandbox email recipient restriction":
    "W trybie sandbox e-maile można wysyłać tylko do zweryfikowanych członków zespołu tego konta.",
  "Sandbox email daily limit exceeded": "To konto sandbox może wysłać tylko {limit} wiadomości e-mail dziennie.",
  "Email and attachment language": "Język wiadomości e-mail i załącznika",
  "PDF Language": "Język PDF",
  "Attach link to PDF": "Dołącz link do PDF",
  "Attach PDF as file": "Dołącz PDF jako plik",
  Default: "Domyślnie",
