export default {
  Peppol: "Peppol",
  "Click to skip Peppol sending for this invoice": "Kliknite da biste preskočili Peppol slanje za ovu fakturu",
  "Click to enable Peppol sending": "Kliknite da omogućite Peppol slanje",
  "Peppol Scheme": "Peppol shema",
  "Peppol ID": "Peppol identifikator",
  Scheme: "Shema",
  Recipient: "Primatelj",
  Name: "Naziv",
  Details: "Pojedinosti",
  ...
  "Advance payments are applied automatically. Record any remaining payment after creating the invoice.":
    "Predujmovi se primjenjuju automatski. Preostalo plaćanje evidentirajte nakon izrade računa.",
  ...
  "Article 76.a": "Članak 76.a",
  "Click to disable Article 76.a reverse charge for this invoice":
    "Kliknite kako biste isključili prijenos porezne obveze prema članku 76.a za ovaj račun",
  "Click to enable Article 76.a reverse charge for this invoice":
    "Kliknite kako biste uključili prijenos porezne obveze prema članku 76.a za ovaj račun",
  "Short fiscal designation, up to 200 characters. Longer wording goes in the description.":
    "Kratki porezni naziv, do 200 znakova. Duži tekst upišite u opis.",
  "Leave empty and the export uses UN.": "Ostavite prazno i izvoz će koristiti UN.",
} as const;
