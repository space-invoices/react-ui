...
// Schemas for customdeliverynote endpoints
...
// Schema for createCustomDeliveryNote operation
const createCustomDeliveryNoteSchemaDefinition = z.object({
  ...
  hide_prices: z.union([z.boolean(), z.null()]).optional(),
...
export type CreateCustomDeliveryNoteSchema = z.infer<typeof createCustomDeliveryNoteSchemaDefinition>;
export const createCustomDeliveryNoteSchema = createCustomDeliveryNoteSchemaDefinition;
