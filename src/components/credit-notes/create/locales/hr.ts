export default {
  "Click to skip Peppol sending for this credit note": "Kliknite da biste preskočili slanje Peppola za ovo odobrenje",
  Recipient: "Primatelj",
  Name: "Naziv",
  Details: "Pojedinosti",
  Number: "Broj",
  ...
  "Portugal credit notes are issued to the customer on the original document.":
    "Portugalske kreditne note izdaju se kupcu s izvornog dokumenta.",
} as const;
