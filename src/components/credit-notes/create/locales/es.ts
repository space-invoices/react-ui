export default {
  "Click to skip Peppol sending for this credit note":
    "Haga clic para omitir el envío de Peppol para esta nota de crédito",
  ...
  "Credit note will be marked as fully paid upon creation":
    "La nota de crédito se marcará como totalmente pagada al crearla",
  ...
  "Portugal credit notes are issued to the customer on the original document.":
    "Las notas de crédito portuguesas se emiten al cliente del documento original.",
} as const;
