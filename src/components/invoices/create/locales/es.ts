export default {
  Peppol: "Peppol",
  "Click to skip Peppol sending for this invoice": "Haga clic para omitir el envío de Peppol para esta factura",
  "Click to enable Peppol sending": "Haga clic para habilitar el envío de Peppol",
  "Peppol Scheme": "Esquema Peppol",
  "Peppol ID": "ID de Peppol",
  Scheme: "Esquema",
  ...
  "Advance payments are applied automatically. Record any remaining payment after creating the invoice.":
    "Los anticipos se aplican automáticamente. Registra cualquier pago restante después de crear la factura.",
