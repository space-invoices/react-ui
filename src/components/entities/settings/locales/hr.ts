export default {
  ...
  "Billing email address": "Adresa e-pošte za naplatu",
  "Recipient for white-label subscription billing emails.": "Primatelj e-pošte za naplatu white-label pretplate.",
  "Used as the From address for document emails and payment reminders after verification passes.":
    "Koristi se kao From adresa za e-poštu dokumenata i podsjetnike za plaćanje nakon uspješne provjere.",
  "DNS DKIM tokens": "DNS DKIM tokeni",
  "Add CNAME records for these tokens at your sender domain, then recheck.":
    "Dodajte CNAME zapise za ove tokene na domeni pošiljatelja, zatim ponovno provjerite.",
  "DNS records are being prepared. Recheck in a moment if they do not appear.":
    "DNS zapisi se pripremaju. Ponovno provjerite za trenutak ako se ne prikažu.",
  "CNAME record": "CNAME zapis",
  Name: "Naziv",
  Value: "Vrijednost",
  Copy: "Kopiraj",
  Copied: "Kopirano",
  Saving: "Spremanje",
  "Save sender": "Spremi pošiljatelja",
  "Update sender": "Ažuriraj pošiljatelja",
  Clear: "Očisti",
  Checking: "Provjera",
  ...
  Email: "E-pošta",
  Domain: "Domena",
  "Inherited from white-label": "Naslijeđeno od white-labela",
  "Entity Email": "E-mail entiteta",
  "Invalid email address": "Neispravna e-mail adresa",
  "Email shown for this entity on documents and template variables":
    "E-mail prikazan za ovaj entitet u dokumentima i varijablama predloška",
  ...
  "Choose how prices, discounts, and taxes are calculated on documents.":
    "Odaberite kako se na dokumentima izračunavaju cijene, popusti i porezi.",
  "EU cross border rules": "Pravila EU-a za prekogranične transakcije",
  "Validate VAT numbers and automate reverse charge for eligible EU transactions.":
    "Provjeravajte PDV identifikacijske brojeve i automatizirajte prijenos porezne obveze za prihvatljive transakcije u EU-u.",
  "Export rules": "Izvozna pravila",
  "Configure automatic tax handling for transactions outside the EU.":
    "Konfigurirajte automatski porezni tretman za transakcije izvan EU-a.",
  "Configure domestic Slovenian tax treatments.": "Konfigurirajte domaće slovenske porezne tretmane.",
  "Slovenian Article 76.a": "Slovenski članak 76.a",
  "Allow eligible domestic business invoices to report VAT under reverse charge.":
    "Omogućite da prihvatljivi domaći poslovni računi prikažu PDV prema prijenosu porezne obveze.",
  "Article 76.a tax clause": "Porezna klauzula prema članku 76.a",
  "Default legal clause added when Article 76.a is selected on an invoice.":
    "Zadana pravna klauzula koja se dodaje kada je na računu odabran članak 76.a.",
